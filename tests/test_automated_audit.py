...
@pytest.mark.skip(
    reason="Integration test: runs full audit pipeline as subprocess; data-dependent and may exceed timeout on resource-constrained systems"
)
...
@pytest.mark.skip(
    reason="Integration test: requires AUDIT_REPORT.txt generated by automated_audit.py; data-dependent"
)
