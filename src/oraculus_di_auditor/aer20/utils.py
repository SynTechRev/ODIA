# src/oraculus_di_auditor/aer20/utils.py
"""Utility functions for Phase 20 (AER-20) deterministic operations."""
...
def sha256_hex(obj: Any) -> str:
    ...
    Follows the pattern established in Phases 17, 18, and 19.
...
def seed_from_input(data: dict[str, Any]) -> int:
    ...
    Follows Phase 18/19 pattern for deterministic pseudo-random operations.
...
class DeterministicRNG:
    ...
    Follows Phase 18/19 pattern for deterministic tie-breaking and sampling.
    """
    ...
    def __init__(self, seed: int):
        ...
        """
        self.state = seed
        # LCG parameters (same as Phase 18/19)
        self.a = 1664525
        self.c = 1013904223
        self.m = 2**32
